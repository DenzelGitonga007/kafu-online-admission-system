...
urlpatterns = [
    ...
    path('download-other-details/<int:user_id>/', views.download_other_details, name='download_other_details'), # Other details download
    path('download-file-details/<int:user_id>/', views.download_file_details, name='download_file_details'), # Files details download
]
...
urlpatterns = [
    ...
    path('download_emergency_contact_details/<int:user_id>/', views.download_emergency_contact_details, name='download_emergency_contact_details'), # energency contact details download
]